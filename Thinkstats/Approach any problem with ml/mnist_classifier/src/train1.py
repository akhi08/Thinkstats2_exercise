...
# --------------- adddition of model in argument
def run(fold,model):
    # read the training data with folds
    ...
    y_valid = df_valid.label.values
    # initialize simple decision tree classifier from sklearn
    # ---------------------change >>>>>> use of model_dispatcher
...
# As we have used multiple models using extension for corresponding
...
# ❯ python src/train1.py --fold 0

# or using
# And you can run this by the following command.
# ❯ sh run_all.sh

# now after certain changes
# ---------------------
# python src/train1.py --fold 0 --model decision_tree_gini
