...
if __name__ == "__main__":
    # Read training data
    df = pd.read_csv("/Users/akhichoudhary/STATS/Thinkstats/Thinkstats2_exercise/Thinkstats/Approach any problem with ml/input/cat-in-data/train.csv")
